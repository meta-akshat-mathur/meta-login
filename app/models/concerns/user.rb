...
module Concerns::User
  ...
  included do
    ...
    # Override Concerns/UserOmniauthCallbacks
    if DeviseTokenAuth.default_callbacks
      include Concerns::UserOmniauthCallbacks
    end
  ...
  def token_is_current?(token, client_id)
    ...
    return true if (
      ...
      Concerns::User.tokens_match?(token_hash, token)
    )
  end
  ...
  def build_auth_header(token, client_id='default')
    ...
    # Override
    # change :uid => self.user_logins.first.uid
